...
#define ORBIT_INFO(message) ORBIT_LOG(message, orbit::Logger::Severity::S_INFO)
#define ORBIT_INFO_HR(message, hr) ORBIT_LOG_HR(message, orbit::Logger::Severity::S_INFO, hr)
#define ORBIT_WARN(message) ORBIT_LOG(message, orbit::Logger::Severity::S_WARN)
#define ORBIT_WARN_HR(message, hr) ORBIT_LOG_HR(message, orbit::Logger::Severity::S_WARN, hr)
#define ORBIT_ERR(message) ORBIT_LOG(message, orbit::Logger::Severity::S_ERR)
#define ORBIT_ERR_HR(message, hr) ORBIT_LOG_HR(message, orbit::Logger::Severity::S_ERR, hr)

#define ORBIT_THROW(message) do { ORBIT_ERR(message); throw orbit::Exception(message); } while(false)
#define ORBIT_THROW_HR(message, hr) do { ORBIT_ERR_HR(message, hr); throw orbit::Exception(message); } while(false)

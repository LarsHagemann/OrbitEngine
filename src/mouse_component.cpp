...
namespace orbit {
	...
	MouseComponent::MouseComponent(EnginePtr engine, ObjectPtr boundObject) :
	...
	std::shared_ptr<MouseComponent> MouseComponent::create(EnginePtr engine, ObjectPtr boundObject)
	{
		return std::make_shared<MouseComponent>(engine, boundObject);
	}
